        ...
        <footer className="footer">
            ...
            <div className="ft-box2">
                ...
                <ul>
                    ...
                    <li><Link to="/restaurant">Register your restaurant</Link></li>
                </ul>
            </div>
            ...
            <h3>More information</h3>
                <ul>
                    <li><Link to="/about">Look all cities</Link></li>
                    <li><Link to="/faq">Read more in our FAQ</Link></li>
                    <li><Link to="/help-us">How you can help me us</Link></li>
                </ul>
            </div>
        </footer>
    );
